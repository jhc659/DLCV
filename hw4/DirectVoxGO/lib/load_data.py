...
def load_data(args, json_path=None):
    ...
    if args.dataset_type == 'llff':
        ...
        if json_path is None:
            images, poses, render_poses, hwf, i_split, filenames = load_blender_data(args.datadir, args.half_res, args.testskip)
        else:
            images, poses, render_poses, hwf, i_split, filenames = load_blender_data(args.datadir, args.half_res, args.testskip, json_path)
