...
'''
coarse_train = dict(
    N_iters=6000,                 # number of optimization steps, default: 5000
...
coarse_model_and_render = dict(
    num_voxels=1024000,           # expected number of voxel, default:1024000
    num_voxels_base=1024000,      # to rescale delta distance, default:1024000
...
fine_model_and_render.update(dict(
    num_voxels=160**3*2,  # default: 160**3
